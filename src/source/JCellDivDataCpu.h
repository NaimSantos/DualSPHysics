...
//==============================================================================
inline StDivDataCpu MakeDivDataCpu(int scelldiv, const tuint3 &ncells, const tuint3 &cellmin, const unsigned* begincell, float scell, unsigned domcellcode, const tdouble3 &domposmin)
{
	StDivDataCpu ret;
