...
//==============================================================================
inline void TmgDestruction(TimersGpu vtimer){
	TmgCreation(vtimer,false);
}

//==============================================================================
/// Marks start of timer.
//==============================================================================
inline void _TmgStart(TimersGpu vtimer,CsTypeTimerGPU ct){
	if(vtimer[ct].active)
		vtimer[ct].timer.Start();
}
...
inline void TmgResetValues(TimersGpu vtimer){
	for(unsigned ct=0;ct<TMG_COUNT;ct++)
		if(vtimer[ct].active)
			vtimer[ct].time=0;
}
...
//==============================================================================
inline void TmgIncreaseValue(TimersGpu vtimer,CsTypeTimerGPU ct,double value){
	if(vtimer[ct].active)
		vtimer[ct].time+=value;
}

//==============================================================================
/// Returns the time accumulated by the timer.
//==============================================================================
inline float TmgGetValue(const TimersGpu vtimer,CsTypeTimerGPU ct){
	return(float(vtimer[ct].time));
}

//==============================================================================
/// Returns the time accumulated by the timer.
//==============================================================================
inline double TmgGetValueD(const TimersGpu vtimer,CsTypeTimerGPU ct){
	return(vtimer[ct].time);
}

//==============================================================================
/// Returns pointer pointing at time accumulated by the timer.
//==============================================================================
inline const double* TmgGetPtrValue(const TimersGpu vtimer,CsTypeTimerGPU ct){
	return(&(vtimer[ct].time));
}
...
//==============================================================================
inline bool TmgIsActive(const TimersGpu vtimer,CsTypeTimerGPU ct){
	return(unsigned(ct)<TmgGetCount()&&vtimer[ct].active);
}

//==============================================================================
/// Activates a given timer.
//==============================================================================
inline void TmgActive(TimersGpu vtimer,CsTypeTimerGPU ct,bool active){
	if(unsigned(ct)<TmgGetCount())
...
//==============================================================================
inline void TmgActiveAll(TimersGpu vtimer,bool active){
	for(unsigned c=0;c<TMG_COUNT;c++)
