...
class JPartOutBi4Save : protected JObject
{
	private:
		...
		JBinaryData* AddPartOut(unsigned cpart, double timestep, unsigned nout, const unsigned *idp, const ullong *idpd,
			const tfloat3 *pos, const tdouble3 *posd, const tfloat3 *vel, const float *rhop, const byte *motive);
		...
		JBinaryData* AddPartOut(unsigned cpart, double timestep, unsigned nout, const unsigned *idp, const tfloat3  *pos , const tfloat3 *vel, const float *rhop, const byte *motive){
			return(AddPartOut(cpart, timestep, nout, idp , NULL, pos , NULL, vel, rhop, motive));
		}
		JBinaryData* AddPartOut(unsigned cpart, double timestep, unsigned nout, const unsigned *idp, const tdouble3 *posd, const tfloat3 *vel, const float *rhop, const byte *motive){
			return(AddPartOut(cpart, timestep, nout, idp , NULL, NULL, posd, vel, rhop, motive));
		}
		JBinaryData* AddPartOut(unsigned cpart, double timestep, unsigned nout, const ullong  *idpd, const tfloat3  *pos , const tfloat3 *vel, const float *rhop, const byte *motive){
			return(AddPartOut(cpart, timestep, nout, NULL, idpd, pos , NULL, vel, rhop, motive));
		}
		JBinaryData* AddPartOut(unsigned cpart, double timestep, unsigned nout, const ullong  *idpd, const tdouble3 *posd, const tfloat3 *vel, const float *rhop, const byte *motive){
			return(AddPartOut(cpart, timestep, nout, NULL, idpd, NULL, posd, vel, rhop, motive));
		}

		//-Grabacion de fichero. File recording.
		void SavePartOut();
		void SavePartOut(unsigned cpart, double timestep, unsigned nout, const unsigned *idp, const tfloat3  *pos , const tfloat3 *vel, const float *rhop, const byte *motive){
			AddPartOut(cpart, timestep, nout, idp , NULL, pos , NULL, vel, rhop, motive); SavePartOut();
		}
		void SavePartOut(unsigned cpart, double timestep, unsigned nout, const unsigned *idp, const tdouble3 *posd, const tfloat3 *vel, const float *rhop, const byte *motive){
			AddPartOut(cpart, timestep, nout, idp , NULL, NULL, posd, vel, rhop, motive); SavePartOut();
		}
		void SavePartOut(unsigned cpart, double timestep, unsigned nout, const ullong  *idpd, const tfloat3  *pos , const tfloat3 *vel, const float *rhop, const byte *motive){
			AddPartOut(cpart, timestep, nout, NULL, idpd, pos , NULL, vel, rhop, motive); SavePartOut();
		}
		void SavePartOut(unsigned cpart, double timestep, unsigned nout, const ullong  *idpd, const tdouble3 *posd, const tfloat3 *vel, const float *rhop, const byte *motive){
			AddPartOut(cpart, timestep, nout, NULL, idpd, NULL, posd, vel, rhop, motive); SavePartOut();
		}

		//-Grabacion de fichero general. General file recording.
		void SavePartOut(bool posdouble, unsigned cpart, double timestep, unsigned nout, const unsigned *idp,
			const tfloat3 *posf, const tdouble3 *posd, const tfloat3 *vel, const float *rhop, const byte *motive);
