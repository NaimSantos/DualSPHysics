...
class JVtkLib : protected JObject
{
	...
	private:
		...
		static void RunExceptioonStatic(const std::string &srcfile, int srcline, const std::string &method, const std::string &msg, const std::string &file=""){}
		...
		void AddShapeBoxFront(const tfloat3  &p, const tfloat3  &px, const tfloat3  &pxz, const tfloat3  &pz, const tfloat3  &py, const tfloat3  &pyx, const tfloat3  &pyxz, const tfloat3  &pyz, int value){}
		void AddShapeBoxFront(const tdouble3 &p, const tdouble3 &px, const tdouble3 &pxz, const tdouble3 &pz, const tdouble3 &py, const tdouble3 &pyx, const tdouble3 &pyxz, const tdouble3 &pyz, int value){}
		...
		void AddShapeSpring(const tfloat3 &p1, const tfloat3 &p2, float restlength, float scalesize, float cornersout, float cornersin, float radius, float revlength, int nsides, int value){}
		void AddShapeSpring(const tdouble3 &p1, const tdouble3 &p2, double restlength, double scalesize, double cornersout, double cornersin, double radius, double revlength, int nsides, int value){}
		...
		static void CreateOBJsByMk(void* ptr_vtksimple, std::string filein, std::string filesout, const std::vector<unsigned> &mkbounds, unsigned mkboundfirst, TpModeNormal normalmode){}
