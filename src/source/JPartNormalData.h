...
class JPartNormalData : protected JObject
{
	...
	public:
		...
		~JPartNormalData();
		void Reset();
		void ConfigBasic(std::string appname, std::string casename, bool data2d, double data2dposy, double dp, double h, double dist, bool ftsupport);
		void AddNormalData(
		std::string partnorname, unsigned nbound, const tdouble3 *partnor, const unsigned *norbegin, unsigned countnor, 
		const tdouble3 *nordata, const double *nordist, const tdouble3 *outdata, const double *outdist);
		void AddNormalData(std::string partnorname, unsigned nbound, const tdouble3 *partnor);
