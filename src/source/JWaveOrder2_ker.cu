...
__device__ void KerReduSumDoubleWarp(volatile double* sdat, unsigned tid){
...
//==============================================================================
template <unsigned blockSize>
__global__ void KerCalcPosition(unsigned n, double time, const double *dnm, const double2 *coefx, double *res)
{
...
//==============================================================================
template <unsigned blockSize>
__global__ void KerCalcElevation(unsigned n, double time, double x, const double4 *coefe, double *res)
{
	extern __shared__ double sdat[];
	unsigned tid=threadIdx.x;
	unsigned c=blockIdx.x*blockDim.x + threadIdx.x;
