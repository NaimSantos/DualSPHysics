...
//==============================================================================
inline void TmcDestruction(TimersCpu vtimer){
	TmcCreation(vtimer,false);
}

//==============================================================================
/// Marks start of timer.
//==============================================================================
inline void _TmcStart(TimersCpu vtimer,CsTypeTimerCPU ct){
	if(vtimer[ct].active)
...
inline void TmcResetValues(TimersCpu vtimer){
	for(unsigned ct=0;ct<TMC_COUNT;ct++)
		if(vtimer[ct].active)
			vtimer[ct].time=0;
}
...
//==============================================================================
inline void TmcIncreaseValue(TimersCpu vtimer,CsTypeTimerCPU ct,double value){
	if(vtimer[ct].active)
...
//==============================================================================
inline float TmcGetValue(const TimersCpu vtimer,CsTypeTimerCPU ct){
...
/// Returns the time accumulated by the timer.
//==============================================================================
inline double TmcGetValueD(const TimersCpu vtimer,CsTypeTimerCPU ct){
...
//==============================================================================
inline const double* TmcGetPtrValue(const TimersCpu vtimer,CsTypeTimerCPU ct){
	return(&(vtimer[ct].time));
}
