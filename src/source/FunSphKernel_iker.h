...
//------------------------------------------------------------------------------
__device__ float GetKernelCubic_Tensil(float rr2, float rhopp1, float pressp1, float rhopp2, float pressp2)
{
...
__device__ float GetKernel_Wab(float rr2){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Wab(rr2));
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_Wab(rr2));
	else
		return(0);
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
template<TpKernel tker>
__device__ float GetKernel_Fac(float rr2){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Fac(rr2));
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_Fac(rr2));
	else
		return(0);
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
template<TpKernel tker>
__device__ float GetKernel_WabFac(float rr2, float &fac){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_WabFac(rr2, fac));
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_WabFac(rr2, fac));
	else
		return(0);
}
#endif
...
//------------------------------------------------------------------------------
template<TpKernel tker>
__device__ float GetKernel_Wab(float rr2, float h, float aker){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Wab(rr2, h, aker));
	else
		return(0);
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
template<TpKernel tker>
__device__ float GetKernel_Fac(float rr2, float h, float bker){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Fac(rr2, h, bker));
	else
		return(0);
}
