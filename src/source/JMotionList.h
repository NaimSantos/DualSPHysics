...
class JMotionList : protected JObject
{
	...
	public:
		...
		void PreMotion(){
			for(unsigned c=0;c<Nref;c++)
				MotionData[c].PreMotion();
		}
		...
		//-Only for double dt acceleration motion.
		void Ace2_Move1dt(unsigned ref, const tdouble3  &mvsimple){
			MotionData[ref].Ace2_Move1dt(mvsimple);
		}
		void Ace2_Move2dt(unsigned ref, const tdouble3  &mvsimple){
			MotionData[ref].Ace2_Move2dt(mvsimple);
		}
		void Ace2_Move1dt(unsigned ref, const tmatrix4d &mvmatrix){
			MotionData[ref].Ace2_Move1dt(mvmatrix);
		}
		void Ace2_Move2dt(unsigned ref, const tmatrix4d &mvmatrix){
			MotionData[ref].Ace2_Move2dt(mvmatrix);
		}
		void Ace2_PosMotion(double dt){
			for(unsigned c=0;c<Nref;c++)
				MotionData[c].Ace2_PosMotion(dt);
		}
