...
//==============================================================================
inline float GetKernelCubic_Tensil(const StKCubicCte &kc, float h, float rr2, float rhopp1, float pressp1, float rhopp2, float pressp2)
{
...
/// Return tensil correction of kernel Cubic.
//==============================================================================
inline float GetKernelCubic_Tensil(const StCteSph &csp, float rr2, float rhopp1, float pressp1, float rhopp2, float pressp2)
{
...
inline float GetKernel_Factor(TpKernel tker){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Factor());
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_Factor());
	return(0);
}
...
inline float GetKernel_Wab(const StCteSph &csp, float rr2){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Wab(csp.kwend, csp.kernelh, rr2));
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_Wab(csp.kcubic , csp.kernelh, rr2));
...
//==============================================================================
template<TpKernel tker>
inline float GetKernel_Fac(const StCteSph &csp, float rr2){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_Fac(csp.kwend  , csp.kernelh, rr2));
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_Fac(csp.kcubic , csp.kernelh, rr2));
...
//==============================================================================
template<TpKernel tker>
inline float GetKernel_WabFac(const StCteSph &csp, float rr2, float &fac){
	if(tker==KERNEL_Wendland)
		return(GetKernelWendland_WabFac(csp.kwend  , csp.kernelh, rr2, fac));
	else if(tker==KERNEL_Cubic)
		return(GetKernelCubic_WabFac(csp.kcubic , csp.kernelh, rr2, fac));
