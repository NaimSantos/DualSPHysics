...
//------------------------------------------------------------------------------
__device__ void InitCte(unsigned rcell,const int &scelldiv,const int4 &nc,const int3 &cellzero,int &ini1,int &fin1,int &ini2,int &fin2,int &ini3,int &fin3)
{
...
/// Devuelve limites de celdas para interaccion.
//------------------------------------------------------------------------------
__device__ void InitCte(const double &px,const double &py,const double &pz,const int &scelldiv,const int4 &nc,const int3 &cellzero,int &ini1,int &fin1,int &ini2,int &fin2,int &ini3,int &fin3)
{
	//-Obtains interaction limits.
...
/// Devuelve limites de celdas para interaccion.
//------------------------------------------------------------------------------
__device__ void Initsp(unsigned rcell,const unsigned &axis,const unsigned &cellcode,const int &scelldiv,
	const int4 &nc,const int3 &cellzero,int &ini1,int &fin1,int &ini2,int &fin2,int &ini3,int &fin3)
{
	//-Obtains interaction limits.
...
/// Devuelve limites de celdas para interaccion.
//------------------------------------------------------------------------------
__device__ void Initsp(const double &px,const double &py,const double &pz,const unsigned &axis,const double3 &domposmin,const float &scell,
	const int &scelldiv,const int4 &nc,const int3 &cellzero,int &ini1,int &fin1,int &ini2,int &fin2,int &ini3,int &fin3)
{
	//-Obtains interaction limits.
...
//------------------------------------------------------------------------------
__device__ void ParticleRange(const int &c2,const int &c3,const int &ini1,const int &fin1,const int2 *begincell,unsigned &pini,unsigned &pfin)
{
	const int v=c2+c3;
...
//==============================================================================
__device__ float Distance2(const float4 &pscellp1,const float4 &pscellp2,const float &poscellsize)
{
